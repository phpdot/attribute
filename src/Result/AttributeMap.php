...
final readonly class AttributeMap
{
    ...
    /**
     * @return array{classes: array<string, array{class: string, structureType: string, implements: list<string>, extends: ?string, results: list<array{attribute: string, arguments: list<mixed>, class: string, target: string, method: ?string, property: ?string, parameter: ?string, constant: ?string}>}>, generatedAt: int, directories: list<string>, filter: list<string>}
     */
